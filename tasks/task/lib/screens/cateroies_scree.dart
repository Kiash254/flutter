...
class _CategoriesState extends State<Categories> {
  ...
  var _categoryservice = Categrieservices();
            ...
            actions: <Widget>[
              FlatButton(
                  ...
                  onPressed: () {
                    ...
                    _category.Descriptiom = _categoryDescription.text;
                    _category.store_number = _categoryStore.text;
                    _category.Ordered_by = _categoryorederdby.text;
                    _category.phone_number = _categoryPhone.text;
